...
def test_site(wordlist):
    site_url = input("\033[1;31m|---|Target Site: \033[0m" ) 
    os.system("clear")
    print("\033[32m| *Attack Started* |\033[0m")
    print("""
    ...
    for word in wordlist:
        test_url = site_url + word
        response = requests.get(test_url)
        if response.status_code == 200:
            print(colored(f"|------>Yes: {test_url}------| ✔️", "green", attrs=["bold"]))
        else:
            print(colored(f"|------>No: {test_url} ------| ❌", "red", attrs=["bold"]))

def signal_handler(sig, frame):
    print("""
    
\033[32mTool Stopped!!!\033[0m""")
    sys.exit(0)
